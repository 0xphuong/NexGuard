...
Instead, please send an email to `security AT nexguard.dev` describing the issue
and we'll respond as soon as possible.

## PGP Key

You may use the public key below to encrypt emails to `security AT nexguard.dev`.
