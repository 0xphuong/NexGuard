defmodule FzHttp.ConfigFixtures do
  ...
  def openid_connect_provider_attrs(overrides \\ %{}) do
    Enum.into(overrides, %{
      "id" => "google",
      "discovery_document_uri" => "https://nexguard.example.com/.well-known/openid-configuration",
  ...
  defp openid_connect_providers_attrs(discovery_document_url) do
    [
      ...
      %{
        ...
        "redirect_uri" => "https://nexguard.example.com/auth/oidc/auth0/callback/",
        "response_type" => "code",
        "scope" => "openid email profile",
        "label" => "OIDC Auth0",
        "auto_create_users" => false
      ...
      %{
        ...
        "redirect_uri" => "https://nexguard.example.com/auth/oidc/azure/callback/",
        "response_type" => "code",
        "scope" => "openid email profile offline_access",
        "label" => "OIDC Azure",
        "auto_create_users" => false
      ...
      %{
        ...
        "redirect_uri" => "https://nexguard.example.com/auth/oidc/onelogin/callback/",
        "response_type" => "code",
        "scope" => "openid email profile offline_access",
        "label" => "OIDC Onelogin",
        "auto_create_users" => false
      ...
      %{
        ...
        "redirect_uri" => "https://nexguard.example.com/auth/oidc/keycloak/callback/",
        "response_type" => "code",
        "scope" => "openid email profile offline_access",
        "label" => "OIDC Keycloak",
        "auto_create_users" => false
      ...
      %{
        ...
        "redirect_uri" => "https://nexguard.example.com/auth/oidc/vault/callback/",
        "response_type" => "code",
        "scope" => "openid email profile offline_access",
        "label" => "OIDC Vault",
        "auto_create_users" => false
