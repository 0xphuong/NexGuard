...
services:
  ...
  firezone:
    ...
    env_file:
      ...
      # See https://nexguard.binhphuong.io.vn/docs/reference/env-vars for more info.
      - ${FZ_INSTALL_DIR:-.}/.env
    volumes:
      # IMPORTANT: Persists WireGuard private key and other data. If
      # /var/nexguard/private_key exists when Firezone starts, it is
      # used as the WireGuard private. Otherwise, one is generated.
      - ${FZ_INSTALL_DIR:-.}/firezone:/var/nexguard
    cap_add:
...
services:
  firezone:
    ...
    volumes:
      ...
      # /var/nexguard/private_key exists when Firezone starts, it is
      # used as the WireGuard private. Otherwise, one is generated.
      - ${HOME}/.firezone/firezone:/var/nexguard
    environment:
